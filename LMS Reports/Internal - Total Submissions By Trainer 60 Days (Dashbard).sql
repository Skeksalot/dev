/*
https://lms.upskilled.edu.au/blocks/configurable_reports/viewreport.php?id=249
*/

SELECT Trainer, '' Student, '' Course, '' Assessment, '' Submit_Time, '' Grade, '' Time_Graded, '' Overdue, COUNT(Submissions) Total_Submissions, Faculty
...
(
	...
	WHERE ( (LOWER(TRIM(a.name)) LIKE 'assessment -%') OR (LOWER(TRIM(a.name)) LIKE 'kcheck -%') )
